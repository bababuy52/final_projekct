    ...
    return (
      <footer className="bg-[#444B58] py-6 mt-[100px]">
        ...
        <div className="flex gap-[10px] ml-[600px] mt-[10px]">
          <a className="text-[white] text-[14px]" href="#">Каталог</a>
          <a className="text-[white] text-[14px]" href="/blog">Блог</a>
          <a className="text-[white] text-[14px]" href="/kartas">Контакты</a>
          <a className="text-[white] text-[14px]" href="#">Наша команда</a>
          <a className="text-[white] text-[14px]" href="#">Доставка и оплата</a>
          <a className="text-[white] text-[14px]" href="#">Контакты</a>
        </div>
        </div>
      </footer>
    );
